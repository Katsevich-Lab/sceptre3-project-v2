#!/usr/bin/env Rscript
# build_neg_control_gasperini.R
# Thin driver: Gasperini (high-MOI) negative-control dataset on the new lib.
# Replaces legacy make_neg_control_gasperini.R.
...
gene_qc_thresh <- 7
random_seed    <- 34369
dataset_name   <- paste0(dataset$name, "_t5_neg_ctrl_ngenes=", num_genes,
