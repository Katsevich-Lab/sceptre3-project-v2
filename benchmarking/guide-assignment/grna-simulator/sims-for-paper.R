...
make_grna_simulation_sum_process <- function(
  ...
  save_rds(true_pert_matrix, file.path(output_dir, "true_pert_matrix.rds"))
  save_rds(cov_dat, file.path(output_dir, "cell_scaling_and_locs.rds"))
  save_rds(sim_params, file.path(output_dir, "sim_params.rds"))
...
make_grna_simulation_sum_process(
  ...
  num_cells = 100,
  num_guides_per_param = 5,
  scep = scep_repl,
  seed = 654
)


grna_mat = read_rds("/home/josep/data/projects/sceptre3/benchmarking/guide_assignment/input_data/new-sims-test/sceptre/grna_matrix.rds")
