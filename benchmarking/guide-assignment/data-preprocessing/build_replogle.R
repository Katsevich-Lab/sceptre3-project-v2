...
# ============================================================================
# build_replogle.R
# Thin driver: build the nested guide-assignment input datasets for Replogle
# (rd7). crispat/pertpy/cleanser only (sceptre deferred). Replaces old
# make_replogle-rd7.R.
...
build_guide_assignment_datasets(
  source_name = "replogle-rd7",
  out_prefix  = "replogle-rd7",
  threshold   = 5,
  K           = 10,
