...
# sum-of-Poissons additive-signal mixture (family = "poissum"):
# y_i ~ (1-pi) Pois(mu0_i) + pi Pois(mu0_i + exp(gamma)). Fit and classify both
# use exp(gamma) as the additive signal mean.
