...
##########################
data_directory=$LOCAL_REPLOGLE_2022_DATA_DIR"/processed/rd7/remove-nts-add-cell-cycle/"
project_directory=$LOCAL_SCEPTRE3_DATA_DIR"/replogle-2022/rd7-remove-nts-add-cell-cycle/"
# sceptre object
