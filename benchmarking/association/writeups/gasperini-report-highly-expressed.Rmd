---
title: "gasperini-analysis-highly-expressed"
output:
...
analysis of positive and negative control on gasperini, only using highly expressed genes.
...
run_name_neg <- "run_gasp_large"
dataset_name_neg <- "gasperini_neg_control_4000genes"

base_path_neg <- file.path(.get_config_path("LOCAL_BENCHMARKING_DIR"),
                                 "association/neg-control")
run_name_pos <- "run_all_skew-t"
dataset_name_pos = "gasperini_pos_control"
...
gene_summary_stats = read_csv(
  file.path(
    .get_config_path("LOCAL_BENCHMARKING_DIR"),
    "guide_assignment/input_data/gasperini/sceptre-pipeline/gene_summary_stats.csv"
  ),
  show_col_types = FALSE
)

highly_expressed_genes = gene_summary_stats |>
...
results_neg[,c("p_value_scep", "p_value_frpert")] |>
...
results_pos[,c("p_value_scep",  "p_value_frpert")] |>
  apply(2, function(v) sum(is.na(v)))
