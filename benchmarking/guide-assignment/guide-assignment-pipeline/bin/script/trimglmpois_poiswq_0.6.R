...
# mixture with a robust weighted-quantile gamma M-step. gamma_update_prob = 0.6
# uses the weighted 0.6-quantile of y/mu0 in place of the (outlier-sensitive)
# weighted mean -- stepping above the y = 0 zero-spike while still trimming the
# upper tail.
