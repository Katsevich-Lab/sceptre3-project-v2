...
# additive NB-signal Poisson mixture (family = "nbsum"): y_i ~ (1-pi) Pois(mu0_i)
# + pi [Pois(mu0_i) + NB(mu = exp(gamma), size = theta)]. Fit and classify both
# use exp(gamma) as the NB signal mean.
