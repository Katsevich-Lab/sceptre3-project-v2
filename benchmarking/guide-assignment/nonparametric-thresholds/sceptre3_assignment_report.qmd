...
Both are the same thing — signal leaking into the 2×2 table's *background* cells when the ambient null
is estimated — landing in different cells and pushing the test opposite ways (the full "three background
cells" account is in `literature_review`).
