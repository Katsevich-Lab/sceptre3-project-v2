# Trimmed Poisson GLM offset (top 0.1% by g dropped), NB-shared mixture
# with 8 phi updates. Initial phi per guide from sceptre:::estimate_theta on
# the trimmed Poisson fit.
