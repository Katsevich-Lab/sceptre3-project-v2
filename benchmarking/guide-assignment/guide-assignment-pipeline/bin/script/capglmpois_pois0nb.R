...
# cells kept, large counts capped), pois0-nb mixture: same as pois-nb but cells
# with g == 0 are forced non-pert (positive-cells-only EM, faster). Poisson
# non-pert component, so no phi/estimate_phi_fn is needed. pi_max=0.5 guard.
