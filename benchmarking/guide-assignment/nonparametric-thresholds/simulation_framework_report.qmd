...
nominal; that "cutoff trap" (the regime-sweep figure below) is the decisive separation. Method *rankings* are
...
cat("Code (in pipeline order, all under scripts/):",
    ...
    "sim_plot_real_distributions.R, sim_plot_within_regime.R.\n")
```
