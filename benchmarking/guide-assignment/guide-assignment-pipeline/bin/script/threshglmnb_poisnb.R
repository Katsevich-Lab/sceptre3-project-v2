...
# pois-nb mixture: (1-pi) Pois(mu0) + pi NB(mu0*exp(gamma), theta). Poisson
# non-pert component, so no phi/estimate_phi_fn is needed. pi_max=0.5 minority
# guard is applied inside the EM.
