...
## in-memory ones for my defense
# dataset_params = data.frame(
#   num_genes =     1000,
#   num_targets =   c(50, 100, 200),
#   max_num_cells = Inf
# ) |>
#   mutate(
#     dataset_name = paste0("gasperini_comp_ngenes=", num_genes,
...
## scep-pipe only ones, for defense
dataset_params = data.frame(
  num_genes =     1000,
  num_targets =   c(400,800,1600),
  max_num_cells = Inf
) |>
  mutate(
    dataset_name = paste0("gasperini_comp_ngenes=", num_genes,
...
for(i in 1:nrow(dataset_params)) {
  ...
  if(exists("METHODS_TO_SKIP")) {
    curr_to_skip = METHODS_TO_SKIP
    cat("skipping", METHODS_TO_SKIP, "\n")
  } else {
    curr_to_skip = ""  # nothing skipped
  }
...
# 
# completed_run = "gasperini_comp_ngenes=1000_ntargets=1600_gene_thresh=7"
...
# scp -r gasperini_comp_ngenes=10000_ntargets=1600_gene_thresh=7 hpc3:/home/stat/jdeu/data/projects/sceptre3/benchmarking/association/computational/input_data
# scp -r gasperini_comp_ngenes=1000_ntargets=1600_gene_thresh=7 hpc3:/home/stat/jdeu/data/projects/sceptre3/benchmarking/association/computational/input_data
# scp -r gasperini_comp_ngenes=1000_ntargets=400_gene_thresh=7 hpc3:/home/stat/jdeu/data/projects/sceptre3/benchmarking/association/computational/input_data
# scp -r gasperini_comp_ngenes=1000_ntargets=800_gene_thresh=7 hpc3:/home/stat/jdeu/data/projects/sceptre3/benchmarking/association/computational/input_data
# scp -r gasperini_comp_ngenes=5000_ntargets=1600_gene_thresh=7 hpc3:/home/stat/jdeu/data/projects/sceptre3/benchmarking/association/computational/input_data
# 
