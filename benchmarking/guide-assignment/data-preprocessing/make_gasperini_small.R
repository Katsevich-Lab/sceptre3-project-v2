...
write.csv(scep@grna_target_data_frame[1:num_cells, ], "~/data/projects/sceptre3/benchmarking/guide_assignment/input_data/gasperini_small/sceptre_input/grna_target_data_frame.csv")
