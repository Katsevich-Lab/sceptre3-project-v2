...
#   )
# 
# write_csv(out, file  ="~/data/projects/sceptre3/benchmarking/guide_assignment/input_data/gasperini/sceptre-pipeline/gene_summary_stats.csv")

out = read_csv("~/data/projects/sceptre3/benchmarking/guide_assignment/input_data/gasperini/sceptre-pipeline/gene_summary_stats.csv")
...
GGally::ggcorr(dplyr::select(out, -gene) |> log1p())
GGally::ggpairs(dplyr::select(out, -gene) |> sample_n(10000) |> log1p())
